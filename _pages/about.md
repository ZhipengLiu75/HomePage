---
permalink: /
title: "About me（Update in 2026.01）👋"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
[3] **Zhipeng Liu**, Peibo Duan, Binwu Wang, Xuan Tang, Qi Chu, Changsheng Zhang, Yongsheng Huang, and Bin Zhang. DisMS-TS: Eliminating Redundant Multi-Scale Features for Time Series Classification. ACM International Conference on Multimedia, ACM MM, 2025 (CCF-A).

[4] **Zhipeng Liu**, Peibo Duan, Qi Chu, Levin Kuhlmann, Changsheng Zhang, Wenwei Yue, Xuan Tang and Bin Zhang. An Attributed Multiplex Network Enabled GNN-based Stock Predictor with Observable and Non-observable Information. Expert Systems With Applications, 2025 (IF=7.5 JCR-Q1).

[5] **Zhipeng Liu**, Peibo Duan, Xiaosha Xue, Changsheng Zhang, Wenwei Yue, and Bin Zhang. A dynamic hypergraph attention network: Capturing market-wide spatiotemporal dependencies for stock selection. Applied Soft Computing, 2025 (IF=7.2 JCR-Q1).
